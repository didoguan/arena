package com.deepspc.arena.config.properties;
...
import static com.deepspc.arena.utils.ToolUtil.getTempPath;

@Component
@ConfigurationProperties(prefix = ArenaProperties.PREFIX)
